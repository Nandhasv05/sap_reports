...
(function () {
 ...
 toggleFiltersBtn?.addEventListener('click', () => { if (!filterRow) return; const ih = filterRow.style.display === 'none'; filterRow.style.display = ih ? '' : 'none'; toggleFiltersBtn.classList.toggle('is-active', ih); });
